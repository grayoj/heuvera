...
export default function Hero() {
    return (
        <div className="relative">
            <div className="bg-[#7B4F3A] rounded-3xl w-full h-[600px] flex flex-col flex-1 justify-center items-center relative overflow-hidden">
                <motion.h1
                    className="text-[#F8F7F2] text-6xl font-serif text-center z-10"
                ...
                <motion.div
                    className='w-32 bg-red-200 h-24 rounded-t-2xl absolute bottom-0 left-10'
                ...
                <motion.div
                    className='w-32 bg-red-200 h-40 rounded-t-2xl absolute bottom-0 right-25'
                    initial={{ y: 100, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                ...
                <motion.div
                    className='w-32 bg-red-200 h-56 rounded-l-2xl shadow shadow-lg absolute top-10 right-0'
                ...
                <motion.div
                    className='w-36 bg-red-200 h-32 rounded-b-2xl shadow shadow-lg absolute top-0 right-80'
                    initial={{ y: -100, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
                ...
                <motion.div
                    className='w-44 bg-red-200 h-56 rounded-b-2xl shadow shadow-lg absolute top-0 left-40'
                    initial={{ y: -100, opacity: 0 }}
                    animate={{ y: 0, opacity: 1 }}
