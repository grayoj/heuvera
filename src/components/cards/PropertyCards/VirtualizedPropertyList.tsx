...
const VirtualizedPropertyList: React.FC<VirtualizedPropertyListProps> = ({ properties, columnsCount }) => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            const visibleRows = Math.ceil(viewportHeight / itemHeight) + bufferSize * 2;
    ...
    const visibleProperties = useMemo(() => {
        const endIndex = Math.min(visibleRangeStart + visibleItemsCount, properties.length);
