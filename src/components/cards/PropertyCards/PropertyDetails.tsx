  ...
  return (
    <div className="h-24 md:h-24 lg:h-24 xl:h-24 2xl:h-28 flex flex-col justify-evenly">
      ...
      <div className="flex flex-row justify-between items-center">
        ...
        {isVerified && (
          <BadgeCheck
            className="size-6 md:size-6 lg:size-5 xl:size-4 2xl:size-6"
            color="#7B4F3A"
          />
        )}
      </div>
      ...
      <div className="flex flex-row justify-between">
        <div className="flex flex-row gap-5 md:gap-5 lg:gap-3 xl:gap-3 2xl:gap-5">
          <div className="gap-1 flex items-center">
            <IoBed className="text-[#898989] text-xl md:text-base lg:text-sm xl:text-base 2xl:text-xl" />
            <h1 className="text-[#898989] text-base md:text-sm lg:text-xs xl:text-sm 2xl:text-base font-serif">
              {beds}
            </h1>
          </div>
          <div className="gap-1 flex items-center">
            <FaBath className="text-[#898989] text-base md:text-base lg:text-xs xl:text-sm 2xl:text-base" />
            <h1 className="text-[#898989] text-base md:text-sm lg:text-xs xl:text-sm 2xl:text-base font-serif">
              {baths}
            </h1>
          </div>
          <div className="gap-1 flex items-center">
            <IoPerson className="text-[#898989] text-xl md:text-base lg:text-sm xl:text-base 2xl:text-xl" />
            <h1 className="text-[#898989] text-base md:text-sm lg:text-xs xl:text-sm 2xl:text-base font-serif">
              {guests}
            </h1>
          </div>
        ...
        <div className="flex flex-row items-center gap-1">
          <h1 className="text-base md:text-sm lg:text-xs xl:text-sm 2xl:text-base font-medium font-serif text-[#898989]">
            {rating}
          </h1>
