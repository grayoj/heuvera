        ...
        >
          <motion.div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e: any) => handleInputChange("occupation", e.target.value)}
            />
          </motion.div>
        ...
        <motion.div className="grid grid-cols-2 md:grid-cols-3 gap-3">
          {interestOptions.map((interest, index) => (
            <motion.div
              ...
              className={`flex items-center space-x-2 bg-transparent border border-[#E3E2D9] dark:border-[#555555] p-2 h-14 rounded-md hover:bg-gray-100 dark:hover:bg-[#444444] transition-colors ${formData.interests.includes(interest.id)
