    ...
    <div className="w-full flex flex-col">
      <div className="gap-3 md:gap-5 flex flex-col">
        <div className="flex flex-col justify-between gap-1">
          <h1 className="text-2xl md:text-2xl lg:text-2xl xl:text-3xl 2xl:text-3xl font-serif font-semibold text-[#3E3E3E]">
            Luxury Apartment in Maitama
          </h1>
          <div className="flex flex-row gap-2">
            <h1 className="text-base md:text-base lg:text-base xl:text-xl 2xl:text-xl font-medium font-serif text-[#323232]">
              4.5
            </h1>
        ...
        <h1 className="text-base md:text-base lg:text-base xl:text-xl 2xl:text-xl font-serif font-normal text-[#3E3E3E]">
