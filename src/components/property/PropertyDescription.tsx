...
export default function PropertyDescription({
  ...
  return (
    <div className="flex flex-col">
      ...
      <p className="text-base font-serif font-normal text-[#333333] dark:text-[#666666]">
        {isExpanded ? propertyDescription : truncatedDescription}
      </p>
      <button
        className="text-base font-serif font-normal text-[#333333] dark:text-[#666666] underline self-start mt-2"
