...
export default function InfoSection({ title, items }: InfoSectionProps) {
  return (
    <div className="w-full border border-[#E3E2D9] dark:border-[#555555] rounded-xl p-0 md:p-6 lg:p-6 xl:p-6 2xl:p-6 flex flex-col gap-3 md:gap-5 lg:gap-5 xl:gap-5 2xl:gap-5">
