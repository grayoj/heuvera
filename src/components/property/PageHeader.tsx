  ...
  return (
    <div className="flex flex-row justify-between">
      ...
      >
        ...
        <h1 className="text-base md:text-sm lg:text-sm xl:text-base 2xl:text-base font-serif text-[#898989]">Island</h1>
      </div>
      <div className="flex flex-row gap-5 items-center">
        <h1 className="text-base md:text-sm lg:text-sm xl:text-base 2xl:text-base font-serif text-[#898989]">Share</h1>
