    ...
    return (
        <>
            ...
            <div className="flex flex-col gap-8">
                <div className="w-full gap-8 flex flex-row justify-between">
                    <div className="flex flex-col gap-4 w-6/12 relative">
                        ...
                        <div className="h-14 w-full border border-[#3E3E3E] rounded-full flex items-center justify-between relative px-6">
                            <h1 className="text-[#3E3E3E] text-base font-serif">{formatDateRange()}</h1>
                            <button
                ...
                <Button className="h-14 w-full bg-[#7B4F3A] rounded-full font-serif font-semibold hover:bg-[#7B4F3A] transition-transform duration-300 hover:scale-105 hover:shadow-lg">Book Now</Button>
            </div>
        </>
    );
}