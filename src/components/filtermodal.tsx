...
function PriceTab({ priceRange, setPriceRange }: PriceTabProps) {
...
function TypeTab({ propertyTypes, togglePropertyType }: TypeTabProps) {
  return (
...
function AmenitiesTab({ amenities, toggleAmenity }: AmenitiesTabProps) {
  return (
    <div className="space-y-3 sm:space-y-4">
      <h3 className="font-medium text-sm sm:text-base md:text-lg mb-1 sm:mb-2">
        Amenities
