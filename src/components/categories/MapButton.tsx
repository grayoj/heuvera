  ...
  return useDrawer ? (
    <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
      <DrawerTrigger asChild>
        <Button
          variant="outline"
          className={`hover:dark:bg-[#55555599] hover:bg-[#F8F7F2] hover:text-[#898989] border border-[#D3D2C9] dark:border-[#555555] text-[#555555] dark:text-[#D3D2C9] shadow-none text-xs sm:text-sm md:text-sm lg:text-base xl:text-base 2xl:text-base font-serif h-10 sm:h-9 md:h-10 px-3 sm:px-4`}
        >
