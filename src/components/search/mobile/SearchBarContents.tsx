...
import {
  ...
  LucideX,
  LucideTrash,
} from "lucide-react"; // Assuming these are the correct import paths
import { useRef, useState } from "react";

const RenderMobileSearchBar: React.FC<RenderMobileSearchBarProps> = ({
  closeSearchModal,
  toggleFilter,
  activeFilter,
  clearAll,
  ...
  const filters = [
    {
      ...
      label: "Where",
      icon: (
        <LucideMapPin className="text-black dark:text-[#A7A7A7]" size={16} />
      ),
    },
    {
      ...
      label: "When",
      icon: (
        <LucideCalendar className="text-black dark:text-[#A7A7A7]" size={16} />
      ),
    },
    {
      ...
      label: "Who",
      icon: (
        <LucideUsers className="text-black dark:text-[#A7A7A7]" size={16} />
      ),
    },
  ];
