                ...
                <div className="flex items-center">
                    ...
                    >
                        <div className="flex flex-col">
                            ...
                            {activeFilter === 'location' ? (
                                ...
                                <span className="font-serif text-sm text-[#323232]">Anywhere</span>
                            )}
                        </div>
                    </div>
                    ...
                    >
                        <div className="flex flex-col">
                            ...
                            <span className="font-serif text-sm text-[#323232]">Any week</span>
                        </div>
                    </div>
                    ...
                    >
                        <div className="flex flex-col">
                            ...
                            <span className="font-serif text-sm text-[#323232]">Add guests</span>
                        </div>
                    </div>
                        ...
                        <AnimatePresence mode="wait">
                            ...
                            {!activeFilter && (
                                ...
                                >
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                                        {['Malibu Beach House - 2 nights', 'Downtown Loft - 3 nights', 'Mountain Cabin - Weekend'].map((search, idx) => (
                                            <motion.div
                                                key={search}
                                                className="flex items-center gap-3 p-4 bg-white shadow-sm rounded-lg cursor-pointer hover:shadow-md transition-shadow"
                                                initial={{ opacity: 0, y: 15 }}
