    ...
    useEffect(() => {
        if (stage === 1) {
            setIsStageValid(prev => ({
                ...prev,
                1: !!(formData.country && formData.state && formData.city && formData.address)
            }));
        }
        else if (stage === 3) {
            setIsStageValid(prev => ({
                ...prev,
                3: !!(formData.preferredRentRange &&
                        ...
                        <Card className="bg-[#F8F7F2] dark:bg-[#333333] shadow-md border-[#E3E2D9] dark:border-[#444444]">
                            <CardHeader>
                                <AnimatePresence mode="wait">
                                    {stage === 1 && (
                                        <Stage1Header key="header-1" stage={stage} />
                                    )}
                                    {stage === 2 && (
                                        <Stage2Header key="header-2" stage={stage} />
                                    )}
                                    {stage === 3 && (
                                        <Stage3Header key="header-3" stage={stage} />
                                    )}
                                </AnimatePresence>
                            </CardHeader>
                            ...
                            <CardFooter className="flex justify-between pt-4">
                                ...
                                {stage < 4 && (
                                    <motion.div
                                        ...
                                        whileHover="hover"
                                        whileTap="tap"
                                        animate={((stage === 1 && !isStageValid[1]) ||
